...
namespace DirectShowLib.Utils
{
    ...
    public static class FilterGraphTools
    {
        ...
        public static string GetINIValue(string filename, string Selection, string KeyName, string DefaultValue)
        {
            //Read INI value
            long RetVal;
            ...
            RetVal = GetPrivateProfileString(Selection, KeyName, DefaultValue, str, 260, filename);
            //Return the string
            return str.ToString();
        }

        public static long SetINIValue(string filename, string Selection, string KeyName, string KeyValue)
        {
            //Write new value to ini file
            return WritePrivateProfileString(Selection, KeyName, KeyValue, filename);
        }

        public static long DeleteINISelection(string filename, string Selection)
        {
            //Delete a selection form ini
            return WritePrivateProfileString(Selection, null, null, filename);
        }

        public static long DeleteINIKey(string filename, string Selection, string KeyName)
        {
            //Deletes a key and it's value
            return WritePrivateProfileString(Selection, KeyName, null, filename);
        }


        [SecurityPermission(SecurityAction.LinkDemand, UnmanagedCode = true)]
        public static IBaseFilter AddFilterFromClsid(this IGraphBuilder graphBuilder, Guid clsid, string name)
        {
            int hr = 0;
        ...
        public static IBaseFilter AddFilterByName(this IGraphBuilder graphBuilder, Guid deviceCategory, string friendlyName)
        {
            int hr = 0;
            IBaseFilter filter = null;
        ...
        [SecurityPermission(SecurityAction.LinkDemand, UnmanagedCode = true)]
        public static IBaseFilter AddFilterByDevicePath(this IGraphBuilder graphBuilder, string devicePath, string name)
        {
            int hr = 0;
            IBaseFilter filter = null;
#if USING_NET11
        ...
        [SecurityPermission(SecurityAction.LinkDemand, UnmanagedCode = true)]
        public static IBaseFilter FindFilterByName(this IGraphBuilder graphBuilder, string filterName)
        {
            int hr = 0;
            IBaseFilter filter = null;
        ...
        [SecurityPermission(SecurityAction.LinkDemand, UnmanagedCode = true)]
        public static IBaseFilter FindFilterByClsid(this IGraphBuilder graphBuilder, Guid filterClsid)
        {
            int hr = 0;
            IBaseFilter filter = null;
            IEnumFilters enumFilters = null;
        ...
        [SecurityPermission(SecurityAction.LinkDemand, UnmanagedCode = true)]
        public static bool RenderPin(this IGraphBuilder graphBuilder, IBaseFilter source, string pinName)
        {
            int hr = 0;
        ...
        [SecurityPermission(SecurityAction.LinkDemand, UnmanagedCode = true)]
        public static void DisconnectPins(this IBaseFilter filter)
        {
            int hr = 0;
        ...
        [SecurityPermission(SecurityAction.LinkDemand, UnmanagedCode = true)]
        public static void DisconnectAllPins(this IGraphBuilder graphBuilder)
        {
            int hr = 0;
        ...
        [SecurityPermission(SecurityAction.LinkDemand, UnmanagedCode = true)]
        public static void RemoveAllFilters(this IGraphBuilder graphBuilder)
        {
            int hr = 0;
            IEnumFilters enumFilters;
        ...
        [SecurityPermission(SecurityAction.LinkDemand, UnmanagedCode = true)]
        public static void SaveGraphFile(this IGraphBuilder graphBuilder, string fileName)
        {
            int hr = 0;
        ...
        [SecurityPermission(SecurityAction.LinkDemand, UnmanagedCode = true)]
        public static void LoadGraphFile(this IGraphBuilder graphBuilder, string fileName)
        {
            int hr = 0;
            IStorage storage = null;
#if USING_NET11
        ...
        public static bool HasPropertyPages(this IBaseFilter filter)
        {
            if (filter == null)
                throw new ArgumentNullException("filter");
        ...
        [SecurityPermission(SecurityAction.LinkDemand, UnmanagedCode = true)]
        public static void ShowFilterPropertyPage(this IBaseFilter filter, IntPtr parent)
        {
            int hr = 0;
            FilterInfo filterInfo;
            DsCAUUID caGuid;
        ...
        public static void ConnectFilters(this IGraphBuilder graphBuilder, IBaseFilter upFilter, string sourcePinName, IBaseFilter downFilter, string destPinName, bool useIntelligentConnect)
        {
            if (graphBuilder == null)
                throw new ArgumentNullException("graphBuilder");
        ...
        [SecurityPermission(SecurityAction.LinkDemand, UnmanagedCode = true)]
        public static void ConnectFilters(this IGraphBuilder graphBuilder, IPin sourcePin, IPin destPin, bool useIntelligentConnect)
        {
            int hr = 0;
...
[Out] out System.Runtime.InteropServices.ComTypes.STATSTG pStatStg,
 ...
 [In] int grfStatFlag
    ...
    public static class MicrosoftDTVDvFilter
    { 
       static Guid CLSID_MicrosoftDTVDVDAudioDecoder = new Guid("{E1F1A0B8-BEEE-490D-BA7C-066C40B5E2B9}"); //msmpeg2adec.d11 
        static Guid LSID_MicrosoftDTVDVDVideoDecoder = new Guid("{212690FB-83E5-4526-8FD7-74478B7939CD}"); 
        public static IBaseFilter Audio 
        {
            get
            {
                return (IBaseFilter)Activator.CreateInstance(Type.GetTypeFromCLSID(CLSID_MicrosoftDTVDVDAudioDecoder));
            }
        }
        public static IBaseFilter Video
        {
            get
            {
                return (IBaseFilter)Activator.CreateInstance(Type.GetTypeFromCLSID(CLSID_MicrosoftDTVDVDAudioDecoder));
